                  ...
                  <div class="modal-body">
                    ...
                    <form method="POST" action="../php/edicao/edita_gasto.php">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea type="text" required class="form-control" id="detalhes" name="descricao" rows="3"><?php echo $descricao; ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group-prepend">
                            ...
                            <input type="number" required step="0.01" class="form-control" id="valor" name="valor" value="<?php echo $valor; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" required class="form-control" id="data" name="data" value="<?php echo $data; ?>">
                        </div>
                      </div>
        ...
        <div class="modal-body">
          ...
          <form method="POST" action="../php/cadastros/cadastra_gasto.php">
            <div class="form-group row">
              <label for="detalhes" class="col-sm-2 col-form-label">Descrição</label>
              <div class="col-sm-10">
                <textarea type="text" required class="form-control" id="detalhes" name="descricao" rows="3"></textarea>
              </div>
            </div>
